...
- [ ] **COLL-01**: AABB broadphase using spatial hash grid producing candidate pairs
...
- [ ] **COLL-06**: Collision filtering via category/mask bitmask (body A collides with B if categories & masks match)
